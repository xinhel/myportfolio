...
// show and hide credit card promo
if (wi <= 615) {
    $('.cc-promo').hide();
    $('.insurance-c-dt').show();
} else {
...
// show and hide stuffs based on window width
...
$('#ins-expand-1').click(function() {
    if ($('#ins-expand-1').text() == "Expand") {
        $('.ins-detail-1').css("display", "block");
        $('#ins-expand-1').html("Collapse");
    } else {
        $('.ins-detail-1').css("display", "none");
        $('#ins-expand-1').html("Expand");
    };
});

$('#ins-expand-2').click(function() {
    if ($('#ins-expand-2').text() == "Expand") {
        $('.ins-detail-2').css("display", "block");
        $('#ins-expand-2').html("Collapse");
    } else {
        $('.ins-detail-2').css("display", "none");
        $('#ins-expand-2').html("Expand");
    };
});
...
function selectInsurance() {
    ...
    if (document.getElementById('ins-option1-button').checked) {
        ...
        var insurance1priceline = '<div class="price-line cf insurance-price-line"><span class="left price-item">Insurance</span><div class="right price-item">$38.00<span class="icon icon-expand" style="visibility:hidden;"></span></div>';
        ...
        // Change price in trip sum
        $('div').remove('.insurance-price-line');
        var insurance2priceline = '<div class="price-line cf insurance-price-line"><span class="left price-item">Insurance</span><div class="right price-item">$68.00<span class="icon icon-expand" style="visibility:hidden;"></span></div>';
